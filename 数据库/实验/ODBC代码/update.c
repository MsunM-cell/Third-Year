...
/* update data from table "tbATUHandOver" */
...
int main(int argc, char* argv[])
{
	...
	SQLRETURN ret;
	ret = SQLExecDirect(V_OD_hstmt, (SQLCHAR*)"update \"tbATUHandOver\" set \"HOATT\" = 66 where \"SSECTOR_ID\" = '123'", SQL_NTS);
	printf("update result: %d\n\n", ret);

	ret = SQLExecDirect(V_OD_hstmt, (SQLCHAR*)"select * from \"tbATUHandOver\" where \"SSECTOR_ID\" = '123'", SQL_NTS);
	int i = 0;
