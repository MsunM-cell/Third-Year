...
/* insert data into table "tbATUHandOver" */
...
int main(int argc, char* argv[])
{
	...
	SQLRETURN ret;
	ret = SQLExecDirect(V_OD_hstmt, (SQLCHAR*)"insert into \"tbATUHandOver\" values ('123', '456', 9)", SQL_NTS);
	printf("insert result: %d\n\n", ret);

	ret = SQLExecDirect(V_OD_hstmt, (SQLCHAR*)"select * from \"tbATUHandOver\"", SQL_NTS);
	int i = 0;
